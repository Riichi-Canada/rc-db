...
def import_event_results_data(csv_path: str, db_path: str) -> None:
    ...
    def get_event_id(event_id: str) -> int:
        """
    ...
    event_df['numeric_event_id'] = event_df['event_id'].apply(get_event_id)
    ...
    if not missing_events.empty:
        ...
        print(missing_events['event_id'])

    event_df.drop(columns=['event_id'], inplace=True)
